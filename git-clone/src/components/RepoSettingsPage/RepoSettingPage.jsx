      ...
      <div className="settings-wrapper">
        ...
        <div className="right-settings">
          <div className="genral-settings">
            ...
            <div className="check-box-input">
              ...
              <div className="checkbox-text">
                ...
                <p>Template repositories let users generate new repositories with the same directory structure and files.</p>
              </div>
            </div>
            <div className="check-box-input">
              <input type="checkbox" name="" />
              <div className="checkbox-text">
                ...
                <p>Enabling this setting will require contributors to sign off on commits made through GitHub’s web interface. Signing off is a way for contributors to affirm that their commit complies with the repository's terms, commonly the Developer Certificate of Origin (DCO). Learn more about signing off on commits.</p>
              </div>
            </div>
            ...
            <div className="social-preview" style={{ marginTop: "20px" }}>
              ...
              <div className="line-break"></div>
              <p>Upload an image to customize your repository’s social media preview.
                <br />
                Images should be at least 640×320px (1280×640px for best display).</p>

              <button className='btn' style={{ marginLeft: '0px' }}>Edit</button>
            </div>
          ...
          <div className="default-branch" style={{ marginTop: "20px" }}>
            ...
            <h3>Pull Requests</h3>
            <div className="line-break"></div>
            <p style={{ margin: "10px 0px" }}>When merging pull requests, you can allow any combination of merge commits, squashing, or rebasing. At least one option must be enabled. If you have linear history requirement enabled on any protected branch, you must enable squashing or rebasing.</p>
          ...
          <div className="danger-zone" style={{ marginTop: "20px" }}>
            ...
            <div className="settings-box">
              ...
              <div className="setting-option">
                ...
                <button className='btn' style={{ marginLeft: '0px', color: "red" }}>Change visibility</button>
              </div>
              ...
              <div className="setting-option">
                ...
                <button className='btn' style={{ marginLeft: '0px', color: "red" }}>Disable branch protection rules</button>
              </div>
              ...
              <div className="setting-option">
                ...
                <button className='btn' style={{ marginLeft: '0px', color: "red" }}>Transfer</button>
              </div>
              ...
              <div className="setting-option">
                ...
                <button className='btn' style={{ marginLeft: '0px', color: "red" }}>Archive this repository</button>
              </div>
              ...
              <div className="setting-option">
                ...
                <button className='btn' style={{ marginLeft: '0px', color: "red" }}>Delete This Repsoitory</button>
              </div>
