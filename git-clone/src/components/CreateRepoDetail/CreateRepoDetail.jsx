            ...
            <div className="repo-detail-wrapper">
                ...
                <div className="box-container">
                    <div className="detail-box">
                        ...
                        <p>Add a README file and start coding in a secure, configurable, and dedicated development environment.</p>
                ...
                <div className="quick-setup-wrapper">
                    <div className="setup-header">
                        <h4>Quick setup — if youve done this kind of thing before</h4>
                        ...
                        <div className="get-started">
                            ...
                            <label htmlFor="file" style={{ color: "blue" }}>upload exsiting file</label>
                            <input type="file" name="file" id="file" className='file-input' />
                            <p>We recommend every repository include a README, LICENSE, and .gitignore.</p>
                        </div>
                    </div>
